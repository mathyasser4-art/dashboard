...
declare type ExcludeKey<K, KeyToExclude> = K extends KeyToExclude ? never : K;
declare type ExcludeField<A, KeyToExclude extends keyof A> = {
...
export declare type MathViewProps = PropsWithChildren<Partial<ExcludeField<React.HTMLAttributes<MathfieldElement>, 'onChange'> & ExcludeField<MathfieldConfig, 'virtualKeyboardToggleGlyph' | 'onFocus' | 'onBlur'> & {
