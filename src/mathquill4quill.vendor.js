/* eslint-disable */
/**
 * Vendored from mathquill4quill@1.0.2
 * Source: https://github.com/c-w/mathquill4quill/blob/v1.0.2/mathquill4quill.js
 *
 * The npm package has no "main" field and is not importable via webpack.
 * This vendor copy adds a proper ESM default export.
 */
...
window.mathquill4quill = function(dependencies) {
  ...
  function enableMathQuillFormulaAuthoring(quill, options) {
    ...
    function areAllDependenciesMet() {
      ...
      if (!MutationObserver) {
        console.log("MutationObserver not defined");
        return false;
      }
      return true;
    }
    ...
    function newOperatorButtons() {
      ...
      function createOperatorButton(element, mqField) {
        ...
        katex.render(displayOperator, button, { throwOnError: false });
        button.onclick = () => {
...
// Export for webpack / CRA bundling
export default window.mathquill4quill;
